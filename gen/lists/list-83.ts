...
export enum BibleVersion {
   ...
   * @default 'CEI'
   */
  ConferenzaEpiscopaleItaliana = <any>'CEI',
   ...
   * @default 'CEN'
   */
  ConferenzaEpiscopaleItaliana_2008 = <any>'CEN',
   ...
   * @default 'GPR'
   */
  GalbiatiPennaRossanoUtet = <any>'GPR',
   ...
   * @default 'GRM'
   */
  GarofanoRinaldiMarietti = <any>'GRM',
   ...
   * @default 'HCS'
   */
  HolmanChristianStandard = <any>'HCS',
   ...
   * @default 'ILC'
   */
  TraduzioneInterconfessionaleInLinguaCorrente = <any>'ILC',
   ...
   * @default 'NAU'
   */
  NewAmericanStandardUpdated = <any>'NAU',
   ...
   * @default 'NBH'
   */
  Bibelen_1978_85Rev_2005 = <any>'NBH',
   ...
   * @default 'NTV'
   */
  NuevaTraduccionViviente = <any>'NTV',
   ...
   * @default 'NVB'
   */
  NovissimaVersioneDellaBibbia = <any>'NVB',
   ...
   * @default 'NVI'
   */
  NuevaVersionInternacional = <any>'NVI',
   ...
   * @default 'PHP'
   */
  NewTestamentInModernEnglish = <any>'PHP',
